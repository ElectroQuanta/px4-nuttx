...
#ifndef __ARCH_ARM_SRC_MX8MN_CHIP_H
#define __ARCH_ARM_SRC_MX8MN_CHIP_H
...
#define ARMV7M_PERIPHERAL_INTERRUPTS MX8MN_IRQ_NEXTINTS

#endif /* __ARCH_ARM_SRC_MX8MN_CHIP_H */

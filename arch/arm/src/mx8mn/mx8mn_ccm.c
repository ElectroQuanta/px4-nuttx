/****************************************************************************
 * arch/arm/src/mx8mn/mx8mn_ccm.c
 *
...
uint32_t mx8mn_ccm_get_root_clock(int clk_root_src)
{
  uint32_t pll;
  uint32_t dsm;
  uint32_t final_div;
...
uint32_t mx8mn_ccm_get_clock(int clk_index)
{
  ...
  src_clk = mx8mn_ccm_get_root_clock(CLK_ROOT_MAP[clk_index][mux]);

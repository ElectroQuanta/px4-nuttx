/****************************************************************************
 * arch/arm/src/mx8mn/mx8mn_lowputc.c
 *
...
#    define CONSOLE_CLK     UART1_CLK_ROOT
...
#    define CONSOLE_CLK     UART2_CLK_ROOT
...
#    define CONSOLE_CLK     UART3_CLK_ROOT
...
int mx8mn_uart_configure(uint32_t base,
...
void mx8mn_lowsetup(void)
{
#ifdef HAVE_UART_CONSOLE
  mx8mn_iomuxc_config(IOMUX_CONSOLE_UART_RX);
  mx8mn_iomuxc_config(IOMUX_CONSOLE_UART_TX);

  uint32_t clk = mx8mn_ccm_get_clock(CONSOLE_CLK);
  mx8mn_uart_configure(CONSOLE_BASE, clk, &g_console_config);
#endif
}

/****************************************************************************
 * arch/arm/src/mx8mn/mx8mn_rsctable.c
 *
...
#define MX8MN_RSC_TABLE_VERSION (1)
...
{
  memcpy((void *)RESOURCE_TABLE_BASE, (void *)&g_mx8mn_rsc_table,
          sizeof(g_mx8mn_rsc_table));
}

/****************************************************************************
 * arch/arm/src/mx8mn/mx8mn_timerisr.c
 *
...
static int mx8mn_timerisr(int irq, uint32_t *regs, void *arg);
...
void up_timer_initialize(void)
{
  ...
  coreclk = mx8mn_ccm_get_clock(ARM_M7_CLK_ROOT);
  ...
  irq_attach(MX8MN_IRQ_SYSTICK, (xcpt_t)mx8mn_timerisr, NULL);
  ...
  up_enable_irq(MX8MN_IRQ_SYSTICK);
}

/****************************************************************************
 * boards/arm/mx8mn/imx8mn-ddr3l-evk/src/mx8mn_buttons.c
 *
...
uint32_t board_button_initialize(void)
{
  ...
  mx8mn_iomuxc_config(BUTTON_1_IOMUX);
  mx8mn_gpio_config(BUTTON_1_GPIO);
...
uint8_t board_buttons(void)
{
  ...
  if (!mx8mn_gpio_read(BUTTON_1_GPIO))
    {
      ret |= BUTTON_1_BIT;
    }

/****************************************************************************
 * boards/arm/mx8mn/imx8mn-ddr3l-evk/src/mx8mn_spidev.c
 *
...
int board_spidev_initialize(int port)
{
  ...
  spi = mx8mn_spibus_initialize(port);
  if (!spi)
    {
...
int mx8mn_spidev_initialize(void)
{
  int ret = 0;

#ifdef CONFIG_MX8MN_SPI1
  mx8mn_iomuxc_config(IOMUX_SPI1_MISO);
  mx8mn_iomuxc_config(IOMUX_SPI1_MOSI);
  mx8mn_iomuxc_config(IOMUX_SPI1_CLK);
  mx8mn_iomuxc_config(IOMUX_SPI1_CS);
  ...
  mx8mn_iomuxc_config(IOMUXC_SPI2_CS);
  mx8mn_gpio_config(GPIO_SPI2_CS);
  ...
  mx8mn_iomuxc_config(IOMUXC_SPI3_MISO);
  mx8mn_iomuxc_config(IOMUXC_SPI3_MOSI);
  mx8mn_iomuxc_config(IOMUXC_SPI3_CLK);
  mx8mn_iomuxc_config(IOMUXC_SPI3_CS);
  mx8mn_gpio_config(GPIO_SPI3_CS);
